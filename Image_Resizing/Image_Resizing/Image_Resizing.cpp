...
int main()
{
	...
	*/
	...
	int quad_width = 20, quad_height = 20;
	...
	*/
	...
	Mat resizing_img = Mat::zeros(new_img_rows, new_img_cols, CV_8UC3);
	...
	imshow("Resized Image", resizing_img);
	imwrite("Resized_" + original_img_name + original_img_type, resizing_img);
	// imwrite(segmentation_img_name + original_img_type, segmentation_img);
